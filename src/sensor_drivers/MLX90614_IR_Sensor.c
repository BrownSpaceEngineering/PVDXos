...
uint16_t MLX90614_read2ByteValue(uint8_t addr, uint8_t mem_addr, uint8_t* buf) {
	...
	//uint16_t sc = readFromAddress(read_buffer, 2, addr, 1);
...
uint16_t MLX90614_read_amb(uint8_t addr, uint8_t* buf){
	//uint16_t read_amb = MLX90614_read2ByteValue(addr, (uint8_t)AMBIENT, buf);
	uint16_t read_amb = MLX90614_read2ByteValue(addr, (uint8_t)OBJ1, buf);
	return read_amb;
};
